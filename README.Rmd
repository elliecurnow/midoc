...
```{r fig.alt=c("Plot of missing data pattern.", "Plot of residuals versus fitted values.", "Plot of imputed (red) values, with distribution of observed (blue) values for comparison.", "Trace plots across 20 iterations.")}
library(midoc)
