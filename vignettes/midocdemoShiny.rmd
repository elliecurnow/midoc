...
**You can explore whether relationships in your own dataset are consistent with your proposed model using a Shiny app, by uploading your dataset (in CSV format) and editing the text in the box below. Note that the diagnostic plot is not displayed (i.e. `modplot` is set to `FALSE`). Further note that if you do not upload a file, the default `bmi` dataset will be analysed.**
...
**You can explore the optimal "mice" options for your own dataset, based on your specified imputation model, using a Shiny app, by uploading your dataset (in CSV format) and editing the text in the box below. Note that the diagnostic plots are not displayed (i.e. `diagplot` is set to `FALSE`). Further note that if you do not upload a file, the default `bmi` dataset will be analysed.**
...
server <- function(input, output) {
    ...
    mimod <- shiny::reactive(midoc::checkModSpec(input$formula,input$family,data(),message=FALSE,modplot=FALSE))
...
server <- function(input, output) {
    ...
    mimod <- shiny::reactive(midoc::checkModSpec(input$impformula,input$impfamily,data(),message=FALSE,modplot=FALSE))
    
    miprop <- shiny::reactive(midoc::proposeMI(mimod(),data(),message=FALSE,diagplot=FALSE))
