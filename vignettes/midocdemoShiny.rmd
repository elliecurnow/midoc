...
**You can draw your own DAG using a Shiny app, by editing the text in the box below. Note that any "in-process" error messages can be ignored (i.e. while you update the input values).**
...
* First specify the DAG for the analysis model, as it would be if there were no missing data. You may find this introduction to DAGs by [Williams et al.](https://doi.org/10.1038/s41390-018-0071-3) useful.
...
**You can check whether CRA is valid for your own DAG and analysis model using a Shiny app, by editing the text in the box below. Note that any "in-process" error messages can be ignored (i.e. while you update the input values).**
...
**You can check whether MI is valid for your own DAG and imputation models (checking the imputation model for each partially observed variable in turn) using a Shiny app, by editing the text in the box below. Note that any "in-process" error messages can be ignored (i.e. while you update the input values).**
