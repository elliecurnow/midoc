...
"Model mis-specification method: regression of model residuals on a fractional polynomial of the fitted values  P-value: 0  A small p-value means the model may be mis-specified. Check the specification of each relationship in your model, noting that the observed relationships may be distorted by data missing not at random.")
...
test_that("checkModSpec correctly identifies that the proposed logistic model
          is mis-specified",
  {
    expect_equal(trimws(paste0(gsub("\n"," ",res3$messages), collapse=" "),"right"),
                 "Model mis-specification method: Pregibon's link test  P-value: 0.012756  A small p-value means the model may be mis-specified. Check the specification of each relationship in your model, noting that the observed relationships may be distorted by data missing not at random.")
