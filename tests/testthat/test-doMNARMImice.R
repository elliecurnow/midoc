...
res1<-evaluate_promise(doMNARMImice(miprop, mnardep="bmi7", mnardelta="-2",123,
        substmod="lm(bmi7 ~ matage + I(matage^2) + mated)"))
#Trim output for test purposes
test_that("doMNARMImice creates both the correct output when a substantive model is
